"""
Django settings for maggotin project.
...
SECRET_KEY = 'django-insecure-h7^c&qjuggg8epmyjy_mltbp+09-e$s7sci&ou3al4%cuw%k38'
...
WSGI_APPLICATION = 'maggotin.wsgi.application'
